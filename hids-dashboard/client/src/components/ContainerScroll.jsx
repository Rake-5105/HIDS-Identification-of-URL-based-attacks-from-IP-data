...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-5xl -mt-12 mx-auto h-[30rem] md:h-[40rem] w-full border-2 border-cyan-500/30 p-2 md:p-6 bg-gray-900/80 rounded-[30px] shadow-2xl shadow-cyan-500/20"
    >
